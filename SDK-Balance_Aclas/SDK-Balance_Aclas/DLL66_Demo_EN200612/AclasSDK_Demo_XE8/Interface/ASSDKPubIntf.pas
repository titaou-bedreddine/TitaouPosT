...
function AclasSDK_Sync_ExecTaskA_PB(Addr, Port, ProtocolType, ProcType, DataType: Cardinal; FileName: PAnsiChar): Integer; stdcall;
function AclasSDK_Sync_ExecTask_PB(Addr, Port, ProtocolType, ProcType, DataType: Cardinal; FileName: PWideChar): Integer; stdcall;
function AclasSDK_Sync_ExecTaskW_PB(Addr, Port, ProtocolType, ProcType, DataType: Cardinal; FileName: PWideChar): Integer; stdcall;
...
function AclasSDK_Sync_ExecTaskA_PB; external LibaryName name 'AclasSDK_Sync_ExecTaskA_PB';
function AclasSDK_Sync_ExecTask_PB; external LibaryName name 'AclasSDK_Sync_ExecTask_PB';
function AclasSDK_Sync_ExecTaskW_PB; external LibaryName name 'AclasSDK_Sync_ExecTaskW_PB';
